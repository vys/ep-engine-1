...
#define DEFAULT_TAP_THROTTLE_PERSIST_THRESHOLD 2000000
#define MIN_TAP_THROTTLE_PERSIST_THRESHOLD 1000000
#define MAX_TAP_THROTTLE_PERSIST_THRESHOLD 10000000
